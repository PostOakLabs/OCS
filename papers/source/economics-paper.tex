...
\date{August 2026 \\[4pt] \small Draft v1.6 (last revised 2026-08-20) --- fourth paper of the set; companion to \emph{The Macro Transcension Hypothesis} (Paper A), the inward-migration review (Paper B),\\ \small the Omega Centauri campaign (Paper C), and the engineered-IMBH systems paper (Paper E);\\ \small prepared for omegacentauri.me}
