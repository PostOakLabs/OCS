...
\caption{The line-of-sight nearest-neighbour jerk density at the corrected and published values of $\xi$, evaluated at the median of the eight per-pulsar floors of the released FLAG D record (paper-set dispersion, fiducial mass-segregated millisecond-pulsar density). Left: the full range, with the eight measured TRAPUM $\ddot{\nu}$ jerks as ticks along the axis; they sit two to three decades above the floor, which is the quantitative form of the statement that they are inconsistent with a cluster origin. The law is 1-stable, so the tail falls as $|\dot{a}|^{-2}$ and no amount of averaging over pulsars contracts it. Right: the peak decade, where the 13.8\,per~cent separation between the two floors is visible. Data and script: \texttt{figs/fH\_jerk\_dist.json}, \texttt{figs/fH\_expand\_v1.py}.}
\label{fig:jerk}
\end{figure}
...
\midrule
A2 $lphaeta\gamma$, 5.20\,kpc & 2.28 & yes & yes & no \
A2 $lphaeta\gamma$, 5.49\,kpc & 2.11 & yes & yes & no \
A2 Plummer, 5.20\,kpc & 1.67 & no & yes & no \
A2 Plummer, 5.49\,kpc & 1.46 & no & yes & no \
$	au{=}0.5$ $lphaeta\gamma$, 5.20\,kpc & 1.42 & no & yes & no \
$	au{=}0.5$ $lphaeta\gamma$, 5.49\,kpc & 1.32 & no & yes & no \
$	au{=}0.5$ Plummer, 5.20\,kpc & 1.36 & no & yes & no \
$	au{=}0.5$ Plummer, 5.49\,kpc & 1.20 & no & yes & no \
$	au{=}2.0$ $lphaeta\gamma$, 5.20\,kpc & 2.36 & yes & yes & no \
$	au{=}2.0$ $lphaeta\gamma$, 5.49\,kpc & 2.17 & yes & yes & no \
