...
\textit{Reduction.} The inner integral over $x$ has an antiderivative in terms of the error function; performing it first leaves a single integral over $\mu$ of $\sqrt{2\pi}\,(1+3\mu^{2})^{-1/2}$, which is elementary and gives the inverse hyperbolic sine. Hence
