...
\date{August 2026 \\[4pt] \small v1.4 (last revised 2026-08-27) --- eighth paper of the set (Paper G); companion to the Macro\\ \small Transcension Hypothesis (Paper A), the inward-migration review (Paper B), the Omega Centauri campaign\\ \small (Paper C), the migration economics (Paper D), the engineered-IMBH systems paper (Paper E), the joint\\ \small accretion bound (Paper F), and the mass-tension paper (Paper H); prepared for omegacentauri.me}
...
Three counts run through this accounting and are not interchangeable: 159, every unidentified source inside the aperture, which is the population Equation~\eqref{eq:residual} subtracts from; 147, those of the 159 at or above the adopted flux limit; and 145, the subset of the 147 carrying a tabulated soft flux, which is the only one of the three a flux-ordered curve can draw.
...
incompleteness. The drawn curve carries the 145 flux-bearing sources of the 147
unidentified sources above the adopted limit, out of the 159 unidentified sources in
the aperture that Equation~\eqref{eq:residual} subtracts from.
...
expectation cross. Two sources of the 159 carry no tabulated soft flux and drop out
of the drawn curve, which is why the curve reads 145 rather than the 147 unidentified
sources at or above the adopted limit, while the residual of Equation~\eqref{eq:residual}
subtracts from the full unidentified count of 159.
...
The confirmed counterparts define a region in the colour-flux plane from this cluster's own data. Four of them ($n=4$: 23g, 11f, 24f, 21d) carry both a tabulated colour and a flux and anchor it; a fifth recovered counterpart lacks a tabulated colour and is dropped. The primary construction is a bounding box on those same four anchors: counting unidentified sources inside it gives 39, of which 14.85 survive membership weighting at the adopted normalisation. A $2\sigma$ ellipse on the same $n=4$ anchors, reported as a secondary and wider construction, gives 53 (19.44 weighted). Both counts rest entirely on the four anchors, and the leave-one-out recounts say so: dropping any one anchor moves the box count over 15--39 and the ellipse count over 7--74 (membership-weighted 6.5--14.9 and 2.0--14.9), because each anchor sets an edge of one construction or the other. The upper-bound reading is unaffected (every recount is still an upper bound), but the point values 39 and 53 should be quoted with these ranges attached. Numbers in \texttt{paper/g/calc7/g\_calc7\_anchor\_loo.json}. Eleven unidentified sources carry neither a colour nor a flux and cannot be placed in the plane at all. Neither region screens for background AGN, so the 39 and 53 counts are upper bounds on MSP-like membership rather than membership estimates.

\begin{figure}[tbp]
\centering
\includegraphics[width=0.92\linewidth]{../figs/fG_expand_colourflux.png}
\caption{The colour-flux plane inside the $480\as$ aperture, with the primary
...
ordering under any of them (\texttt{paper/g/calc7/g\_calc7\_anchor\_loo.json}).
...
published optical identification, which is the catalogue's own field, and the
eleven X-ray counterparts of radio MSPs carry none. Four
...
$\log(\mathrm{soft}/\mathrm{hard})$; $F_{\mathrm{soft}}$ is in
$10^{-16}\,\mathrm{erg\,cm^{-2}\,s^{-1}}$. Flags: \texttt{a} box anchor,
...
\toprule
Rank & Source & $r$ (\as) & colour & $F_{\mathrm{soft}}$ & $P_{\mathrm{member}}$ & $10^{3}\pchance{}$ & $R$ & flags \\
\midrule
...
faint sources, and the five best-placed pool members need factors of 4.0 to 6.0.
...
\label{tab:twelve}
\begin{tabular}{cllccrrrrl}
\toprule
Chart & ID & RA (J2000) & Dec (J2000) & $r$ & $\epsilon_{95}$ & $C_{0.5-4.5}$ & $F_{\rm soft}$ & $R$ & Flags \\
 & & & & (\as) & (\as) & (corr) & ($10^{-19}$) & $F_{12}/F_{00}$ & \\
\midrule
1 & 12c & 13h26m47.945s & $-47$:28:10.74 & 35.7 & 0.41 & 15.5 & 4.0 & --- & n \\
2 & 11e & 13h26m43.279s & $-47$:28:16.18 & 49.6 & 0.43 & 14.6 & 3.6 & --- & n \\
3 & 13g & 13h26m54.065s & $-47$:28:59.06 & 69.8 & 0.41 & 16.9 & 4.8 & --- & n \\
4 & 22l & 13h26m54.828s & $-47$:28:32.66 & 79.1 & 0.40 & 19.6 & 6.2 & --- & n \\
5 & 24j & 13h26m42.326s & $-47$:30:19.33 & 105.4 & 0.45 & 20.9 & 7.4 & --- & n \\
6 & 21e & 13h26m45.206s & $-47$:26:52.25 & 116.3 & 0.39 & 42.3 & 13.9 & 0.96 & e \\
7 & 24d & 13h26m37.399s & $-47$:30:06.97 & 128.7 & 0.49 & 21.2 & 6.4 & 0.98 & --- \\
8 & 23e & 13h26m58.174s & $-47$:29:57.10 & 131.8 & 0.55 & 9.8 & 3.3 & --- & n,l \\
9 & 21f & 13h26m37.860s & $-47$:27:15.51 & 131.8 & 0.48 & 20.6 & 6.9 & --- & n \\
10 & 24b & 13h26m39.312s & $-47$:30:37.06 & 136.4 & 0.50 & 20.0 & 6.0 & 1.02 & --- \\
11 & 22d & 13h26m58.723s & $-47$:27:28.73 & 139.5 & 0.44 & 21.9 & 7.3 & 0.47 & v \\
12 & 34e & 13h26m43.202s & $-47$:31:10.62 & 150.4 & 0.51 & 21.0 & 6.0 & --- & n \\
\bottomrule
\multicolumn{10}{l}{\footnotesize Chart order is pre-registered rank order after removing confirmed MSP counterparts (see Fig.~\ref{fig:findingchart} caption;} \\
\multicolumn{10}{l}{\footnotesize \phantom{Chart} ranks 1--4,6,8,10--15 in \texttt{figs/fG\_target\_list.json}). $R$ is the catalogue 2012/2000 flux ratio where} \\
\multicolumn{10}{l}{\footnotesize \phantom{Chart} tabulated; ``---'' denotes a new 2012 source with no computable ratio (cf.\ Table~\ref{tab:variability}). Flags:} \\
\multicolumn{10}{l}{\footnotesize \phantom{Chart} n\,=\,new in 2012, e\,=\,inside box but outside $2\sigma$ ellipse, l\,=\,$<10$ corrected counts, v\,=\,catalogued} \\
\multicolumn{10}{l}{\footnotesize \phantom{Chart} flux ratio beyond a factor of two ($>2$). All twelve are unidentified and inside the primary box.} \\
\end{tabular}
\end{table}
